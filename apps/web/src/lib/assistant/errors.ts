...
export type AssistantErrorCode = keyof typeof ASSISTANT_ERROR_MESSAGES;

export function getAssistantErrorMessage(code: AssistantErrorCode): string {
  return ASSISTANT_ERROR_MESSAGES[code];
}

export function getPublicAssistantError(): string {
  return ASSISTANT_ERROR_MESSAGES.MODEL_ERROR;
}
