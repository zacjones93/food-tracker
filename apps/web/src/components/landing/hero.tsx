...
export function Hero() {
  return (
    <div className="relative isolate pt-14 dark:bg-mystic-950">
      <div className="pt-20 pb-24 sm:pt-20 sm:pb-32 lg:pb-40">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl text-gradient-mystic">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-4 md:gap-x-6">
              <Link href="/sign-up">
                <Button variant="mystic" size="lg" className="rounded-full">
                  Get Started Free
                </Button>
              </Link>
              <Link href="/sign-in">
