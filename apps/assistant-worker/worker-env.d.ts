/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=AssistantWorkerEnv ./worker-env.d.ts` (hash: 3d14a51f9b4fc60890c341e62be1610c)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_AssistantWorkerEnv {
	DB: D1Database;
	LOADER: WorkerLoader;
	AI_MODEL: "gemini-2.5-flash";
	PROMPT_VERSION: "assistant-code-mode-v9";
	ASSISTANT_CHAT_SESSIONS: DurableObjectNamespace<import("./src/index").AssistantChatSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AssistantChatSession";
	}
	interface Env extends __BaseEnv_AssistantWorkerEnv {}
}
interface AssistantWorkerEnv extends __BaseEnv_AssistantWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "PROMPT_VERSION">> {}
}
