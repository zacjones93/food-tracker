/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface AssistantWorkerEnv ./worker-env.d.ts` (hash: bdc9bd472fa0e4a21de64a0f43710697)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PROMPT_VERSION: "assistant-code-mode-v2";
		DB: D1Database;
		LOADER: WorkerLoader;
		AI: Ai;
	}
}
interface AssistantWorkerEnv extends Cloudflare.Env {}
