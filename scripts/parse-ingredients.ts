...
/**
 * Parse and transform seed.sql file
 */
    ...
    if (insideInsert) {
      ...
      if (line.trim().endsWith(');')) {
        ...
        if (valuesMatch) {
          ...
          // Extract recipeBody - pattern: ..., mealsEatenCount, recipeBody, createdAt, updatedAt, updateCounter
          // mealsEatenCount is a number, recipeBody is a string, then 3 numbers
